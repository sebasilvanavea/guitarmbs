...
class ScalePracticeViewModel: ObservableObject {
    ...
    static let scaleTypes: [ScaleType] = [
        ...
        ScaleType(name: "Frigia",
                  ...
                  colorName: "red"),
        ScaleType(name: "Mixolidia",
                  description: "Mayor con 7ma menor. Rock clásico y blues rock.",
                  intervals: [0, 2, 4, 5, 7, 9, 10],
                  colorName: "orange"),
        ScaleType(name: "Armónica Menor",
                  description: "Menor con 7ma mayor. Sonido árabe y neoclásico.",
                  intervals: [0, 2, 3, 5, 7, 8, 11],
                  colorName: "pink"),
        ScaleType(name: "Melódica Menor",
                  description: "Menor con 6ta y 7ma mayores. Jazz moderno.",
    ...
    // Now delegated to PitchDetector.shared
}
